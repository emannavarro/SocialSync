...
model = tf.keras.models.load_model("//Users//omarjam//PycharmProjects//SocialSync//backend//ml//model.h5")
...
def detect_face(frame_p):
    cascade = cv2.CascadeClassifier("/Users/omarjam/PycharmProjects/SocialSync/backend/ml/haarcascade_frontalface_default.xml")
