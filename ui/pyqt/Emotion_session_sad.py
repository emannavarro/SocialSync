...
class MainWindow(QWidget):
    ...
    def createEmotionBubble(self):
        ...
        emotions = [
            ("Sad: 90%", 90, 110, QColor(12, 150, 67)),
            ("Happiness: 3%", 90, 170, QColor(77, 77, 77)),
    ...
    def createConfidenceSection(self):
        ...
        sad_face_label = QLabel(section)
        sad_face_label.setPixmap(
            QPixmap("images/v25_322.png").scaled(300, 300, Qt.KeepAspectRatio, Qt.SmoothTransformation))
        sad_face_label.setAlignment(Qt.AlignCenter)
        layout.addWidget(sad_face_label)
    ...
    def createExplanationSection(self):
        section = QLabel()
        section.setText("""
        <p><strong style='font-size: 24px;'>Sad:</strong><br>
