...
from PyQt5.QtWidgets import (QApplication, QWidget, QLabel, QPushButton, QVBoxLayout, QHBoxLayout, QSlider, QFrame,
                             QStyleOptionSlider, QStyle, QSizePolicy, QSpacerItem)
...
class CustomButton(QPushButton):
    ...
    def paintEvent(self, event):
        ...
        painter.setFont(QFont('Arial', 28, QFont.Bold))  # Button text size adjusted to match the Profile Setup page
...
class CustomSlider(QSlider):
    ...
    def paintEvent(self, event):
        ...
        if self.value() > self.minimum():
            ...
            filled_width = min(handle_position + 15, self.width())  # Limit the filled width
            painter.drawRoundedRect(0, 0, filled_width, self.height(), 15, 15)
...
class VocalVisualSettingsScreen(QWidget):
    ...
    def initUI(self):
        ...
        # White rounded rectangle - Adjusted size to match ProfileSetup page
        white_frame = QFrame(self)
        white_frame.setFixedSize(800, 600)
        ...
        title.setStyleSheet("font-size: 48px; color: #6AAFA2; font-weight: bold;")
        white_layout.addWidget(title)

        # Add spacing below the title to lower the Voice Volume section
        white_layout.addSpacing(30)  # Adjust this value to increase/decrease the space

        # Voice Volume at the top
        volume_layout = QVBoxLayout()
        self.volume_label = QLabel("Voice Volume: 0%")
        self.volume_label.setStyleSheet("font-size: 22px; color: #2F4858; font-weight: bold;")
        ...
        white_layout.addSpacing(15)  # Adds space between Voice Volume and Visual Overlay section

        # Visual Overlay section below Voice Volume
        visual_layout = QHBoxLayout()
        visual_label = QLabel("Visual Overlay")
        visual_label.setStyleSheet("font-size: 22px; color: #2F4858; font-weight: bold;")
        ...
        white_layout.addSpacing(15)  # Adds vertical space between Visual Overlay and Voice Option

        # Voice Option
        voice_layout = QHBoxLayout()
        voice_label = QLabel("Voice Option")
        voice_label.setStyleSheet("font-size: 22px; color: #2F4858; font-weight: bold;")
        ...
        confirm_button.setStyleSheet("background-color: #71B89A; color: white; font-size: 28px; font-weight: bold;")
