...
class MainWindow(QWidget):
    ...
    def createEmotionBubble(self):
        ...
        emotions = [
            ("Upset: 90%", 90, 110, QColor(191, 27, 27)),
    ...
    def createConfidenceSection(self):
        ...
        upset_face_label = QLabel(section)
        upset_face_label.setPixmap(
            QPixmap("images/v25_321.png").scaled(300, 300, Qt.KeepAspectRatio, Qt.SmoothTransformation))
        upset_face_label.setAlignment(Qt.AlignCenter)
        layout.addWidget(upset_face_label)
